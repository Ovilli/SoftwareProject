...
func _process(_delta):
	...
	if Globals.how_to_open == true or Globals.options_open == true or Globals.muliplayer_open == true or Globals.player_custom_open == true:
		hide()
	else:
		show()
...
func _on_play_pressed() -> void:
	...
	Globals.player_custom_open = true
